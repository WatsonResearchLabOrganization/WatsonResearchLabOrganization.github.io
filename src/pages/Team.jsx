...
export default function Team() {
  ...
  const roleOrder = ['Faculty', 'PhD Students', 'MS Students', 'Masters Students', 'Undergraduate Students', 'Alumni']
                ...
                {groupedTeam[role].map((member, index) => (
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <p className="text-uva-blue text-xs font-medium mb-2">{member.title}</p>
                      
                      {member.bio && (
                        <p className="text-gray-600 text-xs mb-2 line-clamp-2">{member.bio}</p>
                      )}
                        ...
                        <div className="mb-2">
                          <div className="flex flex-wrap gap-1">
                            ...
                            {member.interests.length > 2 && (
                              <span className="text-xs text-gray-400">+{member.interests.length - 2}</span>
                            )}
                          </div>
                        </div>
                      )}
